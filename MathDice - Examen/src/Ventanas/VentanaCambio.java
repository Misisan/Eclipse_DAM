...
public class VentanaCambio extends JPanel {
...
//CONSTRUCTOR**************************************************************************************************CONSTRUCTOR
	...
	public VentanaCambio() {
		...
		//JTextField - NOMBRE //JComboBox
		comboBox = new JComboBox();
		userbd.setUsuariosJCombo(comboBox);
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					usuarioSeleccionado = (Jugador)comboBox.getSelectedItem();
				
					textoApellido1.setText(usuarioSeleccionado.getApellido1());
					textoApellido2.setText(usuarioSeleccionado.getApellido2());
					textoEdad.setText(String.valueOf(usuarioSeleccionado.getEdad()));
					textoPuntos.setText(String.valueOf(usuarioSeleccionado.getPuntos()));
		...
		comboBox.setEnabled(userbd.isConexion_ok());
		panel_03.add(comboBox);
		...
		btn_save.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//Cogemos la información del usuario seleccionado
				player1=usuarioSeleccionado;
...
//MÉTODOS**********************************************************************************************************MÉTODOS
	...
	public void setJugador(Jugador player1, VentanaJuego vJuego, VentanaPerfil vPerfil, VentanaMenu vMenu) {
